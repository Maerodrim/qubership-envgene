"""Shared step definitions for environment instance generation scenarios."""
import json
import yaml
...
def template_descriptor_postfix(workspace, template, postfix):
    ...
    workspace.builder.create_template_descriptor(workspace.cluster_name, workspace.env_name, namespaces)
...
def env_template_artifact(workspace, artifact):
    ...
    workspace.builder.create_inventory_file(workspace.cluster_name, workspace.env_name, content)
